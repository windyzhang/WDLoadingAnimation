...
+ (CALayer *)replicatorLayerWithType:(WDAnimationType)type
{
    ...
    switch (type) {
        ...
        case WDAnimationTypeEmitter:
            ...
            break;
        case WDAnimationTypeCircle:
        {
            layer = [self replicatorLayer_Circle];
        }
            break;
        case WDAnimationTypeWave:
        {
            layer = [self replicatorLayer_Wave];
        }
            break;
        case WDAnimationTypeTriangle:
        {
            layer = [self replicatorLayer_Triangle];
        }
            break;
        case WDAnimationTypeGrid:
        {
